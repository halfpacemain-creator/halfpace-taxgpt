  ...
  head: () => ({
    meta: [
      ...
      { title: "HalfPace TaxGPT — India's AI Tax Expert" },
      {
        name: "description",
        content:
          "AI assistant for Indian taxation and compliance: Income Tax, GST, TDS, ROC, MCA, Trademark, MSME, Startup India and more. Replies in English, Hindi, Urdu and Hinglish.",
      },
    ...
    links: [
      ...
      { rel: "mask-icon", href: "/favicon.svg", color: "#0B5ED7" },
    ],
